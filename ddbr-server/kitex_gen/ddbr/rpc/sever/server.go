...
func (p *HeartbeatReq) Read(iprot thrift.TProtocol) (err error) {
...
func (p *HeartbeatReq) Write(oprot thrift.TProtocol) (err error) {
...
func (p *HeartbeatReq) DeepEqual(ano *HeartbeatReq) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *Heartbeatresp) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_Heartbeatresp[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *Heartbeatresp) ReadField1(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *Heartbeatresp) ReadField255(iprot thrift.TProtocol) error {
	_field := common.NewCommon()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *Heartbeatresp) Write(oprot thrift.TProtocol) (err error) {
...
func (p *Heartbeatresp) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *Heartbeatresp) writeField255(oprot thrift.TProtocol) (err error) {
...
func (p *Heartbeatresp) DeepEqual(ano *Heartbeatresp) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *Heartbeatresp) Field1DeepEqual(src []string) bool {
...
func (p *Heartbeatresp) Field255DeepEqual(src *common.Common) bool {
...
func (p *ServerHeartBeatArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ServerHeartBeatArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ServerHeartBeatArgs) Write(oprot thrift.TProtocol) (err error) {
...
func (p *ServerHeartBeatArgs) DeepEqual(ano *ServerHeartBeatArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ServerHeartBeatArgs) Field1DeepEqual(src *HeartbeatReq) bool {
...
func (p *ServerHeartBeatResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ServerHeartBeatResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ServerHeartBeatResult) Write(oprot thrift.TProtocol) (err error) {
...
func (p *ServerHeartBeatResult) DeepEqual(ano *ServerHeartBeatResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ServerHeartBeatResult) Field0DeepEqual(src *Heartbeatresp) bool {
